...
bool Mountain::Init(TerrainModel* model, const std::string& name)
{
...
void Mountain::Frame(float frameTime)
{
 
} // Frame


void Mountain::Render(ID3D11DeviceContext* context,
    Shader* shader,
    Frustum* frustum,
...
float Mountain::GetHeight(float x, float z) const
{
